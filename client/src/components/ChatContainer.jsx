...
function ChatContainer() {
  ...
  return selectedUser ? (
    <div className=' w-full overflow-scroll relative backdrop-blur-lg'>
      {/* header */}
      <div className=' flex items-center gap-3 mx-4 border-b border-stone-500 py-3'>
      ...
      {/* chat area */}
      <div className='flex flex-col overflow-scroll p-3 h-[calc(100%-120px)] pb-6'>
      ...
      {/* bottom area */}
      <div className=' absolute bottom-0 left-0 ring-0 flex items-center gap-3 p-3'>

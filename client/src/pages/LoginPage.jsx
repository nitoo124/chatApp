...
/>
      ...
      gap-6 rounded-lg shadow-lg'>  
        ...
        <h2 className='flex justify-between items-center font-medium text-2xl'>{currentState}
          {isDataSubmitted && <img
       ...
       {currentState === "Sign up" && !isDataSubmitted &&(
         <input  onChange={(e)=>setFullName(e.target.value)}
           value={fullName}
           type="text" className=' p-2 border border-gray-500
        ...
        text-white rounded-md cursor-pointer '>
          ...
          <div className=' flex flex-col gap-2'>
            {currentState === "Sign up" ? (
              ...
              className='mx-1 font-medium text-violet-500 cursor-pointer'>Login here</span></p>
            ):(
              <p className='text-sm text-gray-600'>Create an account
              <span  onClick={()=>{setCurrentState("Sign up")}}
              className='mx-1 font-medium text-violet-500 cursor-pointer'>Click here</span></p>
            )}
          </div>
